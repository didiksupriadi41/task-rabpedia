        ...
        <tr class ='{{$elemen_upah->id_upah}}'>
            ...
            <td class='changeDBButton'>
              <div class="btn-group btn-group-sm" role="group" aria-label="changeDBButtons">
                <button class='editRow btn btn-secondary btn-success btn-sm text-light font-weight-bold' data-toggle="modal" data-modal-id="{{$elemen_upah->id_upah}}" data-target="#modalEdit" aria-pressed="false" id="{{$elemen_upah->id_upah}}">Edit</button>
              </div>
            </td>
          </tr>
        @endforeach
